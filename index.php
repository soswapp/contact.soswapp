...
<html lang="en" dir="ltr" manifest="/site.webmanifest">
  <head>
    <meta charset="utf-8">
    <title>Contact us | <?php echo PRJ_TITLE; ?></title>
  ...
  <body>
    <?php \TymFrontiers\Helper\setup_page('contact-us','base', true, PRJ_HEADER_HEIGHT); ?>
    <?php include PRJ_INC_HEADER; ?>
    <section id="main-content">
      <div class="view-space">
        <div class="sec-div padding -p10">
          <?php
          if (\file_exists(PRJ_ROOT . "/src/prj-contact.md") && $contact_info = \file_get_contents(PRJ_ROOT . "/src/prj-contact.md")) {
            $contact_info = Markdown::defaultTransform($contact_info);
            echo $contact_info;
          }
           ?>
        </div>
